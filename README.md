...
| 🗄️ **Script de Base de Datos** | `LaVenturosa/bd/init_db.sql` *(en repositorio)* | Script DDl estructurado con el esquema relacional del sistema (`medicion`, `umbral`, `configuracion_alarma`) listo para ser ejecutado. |
