...
public class BackendAppContext {
    ...
    @Bean public MedicionRepository medicionRepository() {
        return new PostgresMedicionRepository();
    }
    @Bean public UmbralRepository umbralRepository() {
        return new PostgresUmbralRepository();
    }
    @Bean public AlertaRepository alertaRepository() {
        return new PostgresAlertaRepository();
    }
    @Bean public ConfiguracionAlarmaRepository configuracionAlarmaRepository() {
